...
//     async function consultar(nomePesquisa = "") {
//         try {
//             if (!linhas_prod) {
//                 console.error(`Element with class "${dpai}" not found in the document.`);
//                 return;
...
//             const rotaAPI = nomePesquisa ? `/produtos/${nomePesquisa}` : '/produtos';
...
//     function mostrarPagina(pagina, dadosFiltrados = null) {
//         const dadosExibicao = dadosFiltrados || dados;
//         const startIndex = (pagina - 1) * itensPorPagina;
//         const endIndex = startIndex + itensPorPagina;

//         linhas_prod.innerHTML = '';

//         const filtroSelect = document.querySelector('.btn_filtro');
//         const filtroSelecionado = filtroSelect.options[filtroSelect.selectedIndex].value;

//         for (let i = startIndex; i < Math.min(endIndex, dadosExibicao.length); i++) {
//             const element = dadosExibicao[i];

//             if (
//                 (filtroSelecionado === 'novo' && element.novo) ||
//                 (filtroSelecionado === 'antigo' && element.antigo) ||
//                 (filtroSelecionado === 'menorvalor' && element.menorvalor) ||
//                 (filtroSelecionado === 'maiorvalor' && element.maiorvalor)
//             ) {
//                 const linhas = criarElementoLinhas(element);
//                 linhas_prod.appendChild(linhas);
//             }
//         }
//     }

//     function criarBotoesPaginacao(dadosFiltrados = null) {
//         const totalPaginas = Math.ceil((dadosFiltrados || dados).length / itensPorPagina);

//         paginacao.innerHTML = '';

//         const btn_before = criarElementoPaginacao('Anterior', function () {
//             if (paginaAtual > 1) {
//                 paginaAtual--;
//                 mostrarPagina(paginaAtual, dadosFiltrados);
//                 atualizarEstiloBotoesPaginacao();
//             }
//         });
//         paginacao.appendChild(btn_before);
...
//         for (let i = paginaAtual; i <= Math.min(paginaAtual + 3, totalPaginas); i++) {
//             const button = criarElementoPaginacao(i, function () {
//                 paginaAtual = i;
//                 mostrarPagina(paginaAtual, dadosFiltrados);
//                 atualizarEstiloBotoesPaginacao();
//             });
...
//         const btn_after = criarElementoPaginacao('Próximo', function () {
//             if (paginaAtual < totalPaginas) {
//                 paginaAtual++;
//                 mostrarPagina(paginaAtual, dadosFiltrados);
//                 atualizarEstiloBotoesPaginacao();
...
//     function criarElementoLinhas(element) {
//         const linhas = document.createElement("div");
//         linhas.setAttribute("class", "linhas");
...
//     function criarElementoPaginacao(texto, callback) {
//         const button = document.createElement('div');
//         button.classList.add('page');
